...
from Thesis.PowerPlants.simple_binary_superheater_NCG_final import ORC as simpleORC
...
def init_cycle(Variables, Parameters):
    ...
    if Parameters["Hot fluid tables"]:
        hot_fluid_tab = Fluid(Parameters["Hot fluid comp"], engine="tables",
                              filename=Parameters["Hot fluid table path"])

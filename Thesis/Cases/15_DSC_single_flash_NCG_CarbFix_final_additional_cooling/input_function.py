...
from Thesis.PowerPlants.single_flash_NCG_CarbFix_final_additional_cooling import DirectCycle as single_flash
...
if __name__ == "__main__":
    ...
    variables = [flash, pmin, absorb]

    plant = calc_Cycle(variables, params)
    print("Wnet:", plant.net_power_elec)
    print("Turbine:", plant.turbine.power_elec)

    # print("LP Brine:", plant.brine_pump_lP.power_elec)
    # print("LP Condensate:", plant.condensate_pump_lP.power_elec)
    # print("LP NCG:", plant.ncg_comp_lp.power_elec)
    # print("HP Brine:", plant.brine_pump_hp.power_elec)
    # print("HP NCG:", plant.ncg_comp_hp.power_elec)
    # print("HP NCG:", plant.ncg_pump_hp.power_elec)

    print("Brine:", plant.brine_pump_lP.power_elec + plant.brine_pump_hp.power_elec + plant.condensate_pump_lP.power_elec)
    print("NCG:", plant.ncg_comp_lp.power_elec + plant.ncg_comp_hp.power_elec + plant.ncg_pump_hp.power_elec)

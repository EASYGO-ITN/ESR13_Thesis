...
Variables_low_bound  = [0.3, 3, 303, 5, 10, 10, 5]
...
SensitivityParams = {
"Hot fluid input2"         : [0.2],
"Hot fluid input1"         : [200+273.15],
"Working fluid comp"       : [["Cyclopentane", 1], ["n-Butane", 1], ],
"DrillingCosts"     : [0, 1, 2, 4, 8, 12, 16, 20, 25, 30, 35, 40, 50, 60]
}

...
Variables_low_bound  = [1.2, 0.01, 303]
Variables_up_bound   = [1.5, 0.99, 400]
...
"Working fluid comp"       : [["n-Propane", 1], ["IsoButane", 1], ["n-Butane", 1], ["Isopentane", 1], ["Cyclopentane", 1], ["n-Heptane", 1],],
}

...
from Thesis.PowerPlants.double_flash import DirectCycle as double_flash
...
def Objective_Function(Variables, Parameters):
    ...
    try:
        ...
        f0 = cycle.net_power_elec  # net power is already negative if the power plant is generating power
        objectives = [f0]
        constraints = []

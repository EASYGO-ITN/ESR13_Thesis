...
if __name__ == "__main__":
    ...
    bs = ax.contour(qs_per, ts, Xflash_, linewidths=1, linestyles="--", colors="k", levels=[0, 5, 10, 20, 40, 60, 80, 100], vmin=0.0, vmax=100)
    ax.clabel(bs, bs.levels, inline=True, fmt=fmt, fontsize=10)

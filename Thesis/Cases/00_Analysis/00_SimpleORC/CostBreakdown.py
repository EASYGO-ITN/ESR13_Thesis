...
if __name__ == "__main_":
    ...
    # tikzplotlib.save("Plots/CostBreakdown_Part_A.tex", figure=aig)
    # tikzplotlib.save("Plots/CostBreakdown_Part_B.tex", figure=big)
    # tikzplotlib.save("Plots/CostBreakdown_Part_C.tex", figure=cig)

if __name__ == "__main__":
    t = 225 + 273.15
    t_id = ORC_ts.index(t)

    temp_fluids = [["n-Propane", 1],
                   ["Isopentane", 1],
                   # ["n-Butane", 1],
                   ["n-Heptane", 1]]
    ...
    for j, f in enumerate(temp_fluids):

        f_id = ORC_fluids.index(f)

        ax[j][0].set_title(ORC_fluids[f_id][0])
        ax[j][1].set_title(ORC_fluids[f_id][0])
        ...
        ax[j][1].set_ylabel("Cost Contribution/\\unit{\\percent}")
        # ax[f_id][1].set_xlabel("Steam Quality/unit{percent}")
        # ax[f_id][1].set_ylabel("Cost Contribution/unit{percent}")
    ...
    tikzplotlib.save("Plots/CostBreakdown_SomeFluids.tex", figure=aig)

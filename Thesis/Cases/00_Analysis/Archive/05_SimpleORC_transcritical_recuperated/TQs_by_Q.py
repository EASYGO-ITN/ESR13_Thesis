...
with open("../../05_SimpleORC_transcritical_recuperated/sensitivity_results.json", "r") as file:
...
if type(TQ) is not float:
    ...
    ax[0].plot(TQ["Q_recu_low"], TQ["T_recu_low"], "k:")
    ax[0].plot(TQ["Q_recu_high"], TQ["T_recu_high"], "k:")
...
if type(TQ) is not float:
    ...
    ax[1].plot(TQ["Q_recu_low"], TQ["T_recu_low"], "k:")
    ax[1].plot(TQ["Q_recu_high"], TQ["T_recu_high"], "k:")
...
if type(TQ) is not float:
    ...
    ax[2].plot(TQ["Q_recu_low"], TQ["T_recu_low"], "k:")
    ax[2].plot(TQ["Q_recu_high"], TQ["T_recu_high"], "k:")
...
if type(TQ) is not float:
    ...
    ax[3].plot(TQ["Q_recu_low"], TQ["T_recu_low"], "k:", label="Recuperation")
    ax[3].plot(TQ["Q_recu_high"], TQ["T_recu_high"], "k:")

...
with open("../../04_SimpleORC_superheated_recuperated/Part_a/sensitivity_results.json", "r") as file:
    results_a = json.load(file)

with open("../../04_SimpleORC_superheated_recuperated/Part_b/sensitivity_results.json", "r") as file:
    results_b = json.load(file)

with open("../../04_SimpleORC_superheated_recuperated/Part_c/sensitivity_results.json", "r") as file:

...
from Thesis.PowerPlants.single_flash_NCG import DirectCycle as single_flash
...
if __name__ == "__main__":
    zc = 0.03
    flash = 0.639478522637973
    pmin = 12046.687032093228

    params = {
        "is Cycle regenerated": False,
        "Hot fluid comp": ["water", 0.95, "carbondioxide", zc],

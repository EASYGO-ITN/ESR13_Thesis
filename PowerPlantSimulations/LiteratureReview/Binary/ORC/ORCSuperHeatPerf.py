...
wf.update(cp.PT_INPUTS, P_wf_evap, T_wf_evap + DT_superheat)
...
# TS Diagram
ss = [S_wf_in/1000, S_wf_pump_out/1000, S_wf_PHE_sat/1000, S_wf_PHE_vap/1000, S_wf_PHE_out/1000, S_wf_turb_out/1000, S_wf_cond_sat/1000, S_wf_cond_out/1000]
ts = [T_wf_in, T_wf_pump_out, T_wf_PHE_sat, T_wf_PHE_vap, T_wf_PHE_out, T_wf_turb_out, T_wf_cond_sat, T_wf_cond_out]
...
tikzplotlib.save("ORCSuperHeatPerf.tex")

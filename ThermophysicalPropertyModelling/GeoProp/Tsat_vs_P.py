...
rkt_SRK_AbsDiff = rkt_SRK_Tsat - water_Tsat
rkt_ideal_AbsDiff = rkt_ideal_Tsat - water_Tsat

rkt_SRK_PercentDiff =100 * rkt_SRK_AbsDiff / water_Tsat
rkt_ideal_PercentDiff = 100 * rkt_ideal_AbsDiff / water_Tsat

print("REAKTORO - SRK")
print("AbsVal")
print(to_tex2D(ps, rkt_SRK_AbsDiff))
print("Percentage")
print(to_tex2D(ps, rkt_SRK_PercentDiff))

print("REAKTORO - Ideal")
print("AbsVal")
print(to_tex2D(ps, rkt_ideal_AbsDiff))
print("Percentage")
print(to_tex2D(ps, rkt_ideal_PercentDiff))

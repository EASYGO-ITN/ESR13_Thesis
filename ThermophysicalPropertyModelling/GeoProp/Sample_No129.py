...
No129_density = np.array([1002.04, 1001.69, 1000.17, 997.55, 994.05, 989.60, 984.6])

h_ts = np.array([273.2, 278.15, 283.15, 293.15, 303.15, 313.15, 323.15, 333.15])
No129_enthalpy = np.array([0.0, 21.430, 42.927, 85.492, 127.82, 170.03, 212.25, 254.60]) - (85.492+ 127.82)/2
...
print("___No129___;")
print("Density")
print(to_tex2D(rho_ts, No129_density ))
print("Enthalpy")
print(to_tex2D(h_ts, No129_enthalpy))

...
print("Water")
print("HeatContent")
print(to_tex2D(hmax - cp_hs, cp_ts))
print("Vapour Quality")
print(to_tex2D(hmax - cp_hs, cp_xs))

print("Brine")
print("HeatContent")
print(to_tex2D(hmax - geoprop_brine_hs, geoprop_brine_ts))
print("Vapour Quality")
print(to_tex2D(hmax - geoprop_brine_hs, geoprop_brine_xs))

print("Water&NCG")
print("HeatContent")
print(to_tex2D(hmax - cp_hs, geoprop_watNCG_ts))
print("Vapour Quality")
print(to_tex2D(hmax - cp_hs, geoprop_watNCG_xs))

print("Brine&NCG")
print("HeatContent")
print(to_tex2D(hmax - cp_hs, geoprop_brineNCG_ts))
print("Vapour Quality")
print(to_tex2D(hmax - cp_hs, geoprop_brineNCG_xs))

...
class ORC(BinaryCycle):
    ...
    def __calc_heat_introduction(self, brine, vapour, WF_preh_in, WF_evap_in, WF_turbine_in):
        ...
        WF_Mrate_Evap = temp_vapour.m * self.evaporator.MassRatio
        ...
        if WF_Mrate_PreH > WF_Mrate_Evap:
            ...
            VapourMassRatio = WF_Mrate_PreH / temp_vapour.m

            self.evaporator.set_inputs(MassRatio=VapourMassRatio, Inlet_hot=temp_vapour, Inlet_cold=WF_evap_in,
                            Outlet_cold=WF_turbine_in)
            vapour_out, temp_WF_turbine_in = self.evaporator.calc()
    ...
    def calc(self, P_max, T_max, T_min, P_min=None):
        ...
        self.preheater.update_inlet_rate(self.brine.m, self.wfluid.m)
    ...
    def calc_exergy_balance(self):
        ...
        self.Eloss = self.separator.Eloss + self.evaporator.Eloss + self.preheater.Eloss + self.condenser.Eloss + self.recuperator.Eloss + self.feedpump.Eloss + self.turbine.Eloss + self.mixer.Eloss

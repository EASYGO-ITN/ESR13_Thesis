...
class DirectCycle(Cycle):
    ...
    def __init__(self):
        ...
        self.ncg_pump = Simulator.multistage_compression(0.85, 1, cost_model="default")
    ...
    def __calc_mass_rates(self, vapour, brine, ncg, condensate):
        ...
        m_vap = self.geofluid.m*vapour.m
        m_brine = self.geofluid.m*brine.m
        m_ncg = self.geofluid.m*ncg.m
        m_cond = self.geofluid.m*condensate.m
        ...
        self.geofluid_out._update_quantity(self.geofluid.m)
